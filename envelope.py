...
def convertation():
    ...
    from_currency = None
    to_currency = None
    list_of_conv = microphone.voice.split()
    ...
    while money is None:
        try:
            ...
            microphone.speak("Скажите, к примеру: 50 долларов в рубли")
            break
    while from_currency is None:
        ...
        try:
            ...
            from_currency = None
            microphone.speak("Скажите, например: 50 долларов в рубли")
            break
    ...
    while True:
        try:
            microphone.speak(f"{money} {from_currency} в {to_currency} - "
